...
public class CustomerDBUtil {
	...
	public static List<Customer> validate(String username, String password) {
	    ...
	    try {
	        ...
	        con = DBConnect.getConnection();
	        stmt = con.createStatement();
	        String sql = "select * from customer";  // Fetch all rows and manually check the username and password
	        rs = stmt.executeQuery(sql);
	        ...
	        while (rs.next()) {
	            ...
	            if (dbUsername.equals(username) && dbPassword.equals(password)) {
	                // If matched, create a Customer object
	                int id = rs.getInt("id");
	                ...
	                int zippostalcode = rs.getInt("zippostalcode");
	                String gender = rs.getString("gender");

	                // Create Customer object and add it to the list
	                Customer c = new Customer(id, name, userU, email, address, dateofbirth, phone, zippostalcode, gender, dbPassword);
	                cus.add(c);  // Add matched row to the list
	            }
	        }
	    ...
	    return cus;  // Return the list of matched rows
	}
